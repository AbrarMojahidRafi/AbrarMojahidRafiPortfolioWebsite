...
const AdminContacts = () => {
  ...
  const getAllContactsData = async () => {
    try {
      const response = await fetch(
        "http://localhost:3000/api/admin/AbrarMojahidRafi_PortfolioWebsite/contacts",
        {
          method: "GET",
          headers: {
  ...
  const deleteContact = async (contactId) => {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/api/admin/AbrarMojahidRafi_PortfolioWebsite/contacts/delete/${contactId}`,
        {
          method: "DELETE",
          headers: {
            "Content-Type": "application/json",
